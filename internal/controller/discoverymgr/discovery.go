...
func (d *DiscoveryImpl) AddDeviceInfo(deviceID string, virtualAddr string, privateAddr string) {
	...
	output := strings.ReplaceAll(strings.ReplaceAll(privateAddr,"\n",""),"\r","")
	log.Println(logPrefix, "[AddDeviceInfo]", "private Addr", fmt.Sprintf("%#v",output))
	log.Println(logPrefix, "[AddDeviceInfo]", "private Addr", strings.ReplaceAll(fmt.Sprintf("%#v",output),"\"",""))
	log.Println(logPrefix, "[AddDeviceInfo]", "Virtual Addr", fmt.Sprintf("%#v",strings.ReplaceAll(strings.ReplaceAll(virtualAddr,"\n",""),"\r","")))
	log.Println(logPrefix, "[AddDeviceInfo]", "private Addr", fmt.Sprintf("%#v",privateAddr))
